...
#importing csv files
authorsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\authors.csv')
mainauthorsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\main_authors.csv')
coauthorsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\coauthors.csv')
conferencesData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\Conferences_editions2.csv')
conferencesEditionsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\conferences_editions_data.csv')
conferencesEditionsPapersData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\conferencesEditions_papers.csv')
workshopsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\Workshops_editions2.csv')
workshopsEditionsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\workshops_editions_data.csv')
workshopsEditionsPapersData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\workshopEditions_papers.csv')
journalsData= pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\journals.csv')
journalvolumesData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\journals_volumes.csv')
papersData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\papers.csv')
volumesData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\volumes.csv')
volumesPapersData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\volumes_papers.csv')
companies_authorsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\companies_authors.csv')
universities_authorsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\universities_authors.csv')
universitiesData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\universities.csv')
companiesData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\companies.csv')
reviewsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\modified_reviews_papers2.csv')
citationsData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\citations.csv')
keywordData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\keywords.csv')
keywordPaperData = pd.read_csv('C:\\Users\\Dima\\SDM_submission\\sdm-lab2\\data\\keywords_papers.csv')
...
for i in range(len(conferencesData)):
    ...
    graph.add((URIRef(lab2 + "Edition"+str(row.iloc[1])), lab2.city_conference, Literal(row.iloc[4])))
...
for i in range(len(workshopsData)):
    ...
    graph.add((URIRef(lab2 + "Edition"+str(row.iloc[1])), lab2.city_workshop, Literal(row.iloc[4])))
